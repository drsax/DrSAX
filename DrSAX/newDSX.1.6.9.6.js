(function(window) {
    ...
    DSX.prototype.freqDomain = function(out) {
        ...
        ctx_frequency = canvas.getContext('2d');
        frameLooper();
        ...
        function frameLooper() {
            ...
            ctx_frequency.clearRect(0, 0, canvas.width, canvas.height); // Clear the canvas
            ...
            for (var i = 0; i < bars; i++) {
                ...
                ctx_frequency.fillRect(bar_x, canvas.height, bar_width, bar_height);
            }
        }
